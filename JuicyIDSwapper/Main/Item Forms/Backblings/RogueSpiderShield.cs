...
{
    public partial class RogueSpiderShield : Form
    {
        public RogueSpiderShield()
        {
            InitializeComponent();
        ...
        private void RogueSpiderShield_Load(object sender, EventArgs e)
        {
            if (Properties.Settings.Default.RogueSpiderShieldEnabled == true)
            {
        ...
        string ID = "BID_513_GraffitiAssassin.BID_513_GraffitiAssassin";
        string ID1 = "BID_346_BlackWidowRogue.BID_346_BlackWidowRogue";
        ...
        private void backgroundWorker1_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            if (convertButton.Text == "Convert")
            {
                ...
                {
                    richTextBox1.Text += "\n[LOG] ID added!";
                    Settings.Default.RogueSpiderShieldEnabled = true;
            ...
            else
            {
                ...
                {
                    richTextBox1.Text += "\n[LOG] ID removed!";
                    Settings.Default.RogueSpiderShieldEnabled = false;
                    Settings.Default.Save();
                }
                convertButton.Text = "Convert";
                stopwatch.Stop();
