...
{
    public partial class DarkDeflector : Form
    {
        public DarkDeflector()
        {
            InitializeComponent();
        ...
        private void DarkDeflector_Load(object sender, EventArgs e)
        {
            if (Properties.Settings.Default.DarkDeflectorEnabled == true)
            {
        ...
        string ID = "BID_367_TacticalFishermanMale.BID_367_TacticalFishermanMale";
        string ID1 = "BID_234_SpeedyMidnight.BID_234_SpeedyMidnight";
        ...
        private void backgroundWorker1_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            if (convertButton.Text == "Convert")
            {
                ...
                {
                    richTextBox1.Text += "\n[LOG] ID added!";
                    Settings.Default.DarkDeflectorEnabled = true;
            ...
            else
            {
                ...
                {
                    richTextBox1.Text += "\n[LOG] ID removed!";
                    Settings.Default.DarkDeflectorEnabled = false;
                    Settings.Default.Save();
                }
                convertButton.Text = "Convert";
                stopwatch.Stop();
