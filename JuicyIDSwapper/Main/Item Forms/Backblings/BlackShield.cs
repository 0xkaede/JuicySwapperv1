...
namespace JuicyIDSwapper.Main.GUI
{
    public partial class BlackShield : Form
    {
        ...
        private void BlackShield_Load(object sender, EventArgs e)
        {
        ...
        string ID = "BID_368_RockClimber.BID_368_RockClimber";
        string ID1 = "BID_004_BlackKnight.BID_004_BlackKnight";
