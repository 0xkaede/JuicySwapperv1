...
namespace JuicyIDSwapper.Main.GUI
{
    public partial class PonyUp : Form
    {
        ...
        private void PonyUp_Load(object sender, EventArgs e)
        {
        ...
        string ID = "EID_PartyJazzTwinkleToes.EID_PartyJazzTwinkleToes";
        string ID1 = "EID_RideThePonyTwo.EID_RideThePonyTwo";
