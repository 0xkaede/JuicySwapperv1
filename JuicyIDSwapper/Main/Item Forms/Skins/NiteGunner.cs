...
{
    public partial class NiteGunner : Form
    {
        public NiteGunner()
        {
            InitializeComponent();
        ...
        private void NiteGunner_Load(object sender, EventArgs e)
        {
            if (Properties.Settings.Default.NiteGunnerEnabled == true)
            {
        ...
        string ID1 = "CID_782_Athena_Commando_M_BrightGunnerEclipse.CID_782_Athena_Commando_M_BrightGunnerEclipse";
        ...
        private void backgroundWorker1_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            if (convertButton.Text == "Convert")
            {
                ...
                {
                    richTextBox1.Text += "\n[LOG] ID added!";
                    Settings.Default.NiteGunnerEnabled = true;
            ...
            else
            {
                ...
                {
                    richTextBox1.Text += "\n[LOG] ID removed!";
                    Settings.Default.NiteGunnerEnabled = false;
                    Settings.Default.Save();
                }
                convertButton.Text = "Convert";
                stopwatch.Stop();
