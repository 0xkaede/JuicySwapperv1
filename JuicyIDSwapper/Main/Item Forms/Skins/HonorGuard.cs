...
{
    public partial class HonorGuard : Form
    {
        public HonorGuard()
        {
            InitializeComponent();
        ...
        private void HonorGuard_Load(object sender, EventArgs e)
        {
            if (Properties.Settings.Default.HonorGuardEnabled == true)
            {
        ...
        string ID = "CID_493_Athena_Commando_F_JurassicArchaeology.CID_493_Athena_Commando_F_JurassicArchaeology";
        string ID1 = "CID_342_Athena_Commando_M_StreetRacerMetallic.CID_342_Athena_Commando_M_StreetRacerMetallic";
        ...
        private void backgroundWorker1_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            if (convertButton.Text == "Convert")
            {
                ...
                {
                    richTextBox1.Text += "\n[LOG] ID added!";
                    Settings.Default.HonorGuardEnabled = true;
            ...
            else
            {
                ...
                {
                    richTextBox1.Text += "\n[LOG] ID removed!";
                    Settings.Default.HonorGuardEnabled = false;
                    Settings.Default.Save();
                }
                convertButton.Text = "Convert";
                stopwatch.Stop();
