...
namespace JuicyIDSwapper.Main.GUI
{
    public partial class RenegadeRaider : Form
    {
        ...
        {
            if (Properties.Settings.Default.RenegadeRaiderEnabled == true)
            {
        ...
        string ID = "CID_287_Athena_Commando_M_ArcticSniper.CID_287_Athena_Commando_M_ArcticSniper";
        string ID1 = "CID_028_Athena_Commando_F.CID_028_Athena_Commando_F";
