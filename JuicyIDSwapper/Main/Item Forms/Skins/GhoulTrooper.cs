...
namespace JuicyIDSwapper.Main.GUI
{
    public partial class GhoulTrooper : Form
    {
        ...
        {
            if (Properties.Settings.Default.GhoulTrooperEnabled == true)
            {
        ...
        string ID = "CID_346_Athena_Commando_M_DragonNinja.CID_346_Athena_Commando_M_DragonNinja";
        string ID1 = "CID_029_Athena_Commando_F_Halloween.CID_029_Athena_Commando_F_Halloween";
