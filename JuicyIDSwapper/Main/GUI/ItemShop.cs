...
namespace JuicyIDSwapper.Main.GUI
{
    public partial class ItemShop : Form
    {
        ...
        {
            var request = WebRequest.Create("https://api.nitestats.com/v1/shop/image?header=JUICY%20ID%20SWAPPER&footer=twitter.com/juicyindustries&textcolor=ffa500&background=19162A");
