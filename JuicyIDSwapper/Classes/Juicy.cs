...
namespace JuicyIDSwapper
{
    public class Juicy
	{
        public static readonly DiscordRpcClient discordrpc = new DiscordRpcClient("732652012826525706");
		...
		public static bool Devmode()
		{
			...
			{
				client.Proxy = null;
				var encr = client.DownloadString("https://juicyswapper.xyz/api/id/devmode");
