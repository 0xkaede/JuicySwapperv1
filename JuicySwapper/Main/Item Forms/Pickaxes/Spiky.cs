...
{
    public partial class Spiky : Form
    {
        public Spiky()
        {
            InitializeComponent();
        ...
        {
            if (Properties.Settings.Default.SpikyEnabled == true)
            {
        ...
        string Mesh = "/Game/Weapons/FORT_Melee/Pickaxe_Desert_Ops_Camo_Female/Meshes/Desert_Ops_Camo_Female_Axe.Desert_Ops_Camo_Female_Axe";
        string Mesh1 = "/Game/Weapons/FORT_Melee/Meshes/SK_Pickaxe_Spikes.SK_Pickaxe_Spikes";
        string Swing = "/Game/Athena/Sounds/Weapons/PickAxes/DesertOpsCamoFemale/PickAxe_DesertOpsCamoFemale_Swing_Cue.PickAxe_DesertOpsCamoFemale_Swing_Cue";
        string Swing1 = "/Game/Athena/Sounds/Weapons/PickAxes/PickAxe_Spikey_Swing_Athena_Cue.PickAxe_Spikey_Swing_Athena_Cue";
        string Impact = "/Game/Athena/Sounds/Weapons/PickAxes/DesertOpsCamoFemale/PickAxe_DesertOpsCamoFemale_Impact_Player_Cue.PickAxe_DesertOpsCamoFemale_Impact_Player_Cue";
        string Impact1 = "/Game/Sounds/Fort_Impact_Sounds/Flesh/Player_Impact_PA_Spikey_Cue.Player_Impact_PA_Spikey_Cue";
        string Equip = "/Game/Athena/Sounds/Weapons/PickAxes/DesertOpsCamoFemale/PickAxe_DesertOpsCamoFemale_Ready_Cue.PickAxe_DesertOpsCamoFemale_Ready_Cue";
        string Equip1 = "/Game/Athena/Sounds/Weapons/PickAxes/DesertOpsCamoFemale/PickAxe_DesertOpsCamoFemale_Ready_Cue.PickAxe_DesertOpsCamoFemale_Ready_000";
        string icon = "/Game/UI/Foundation/Textures/Icons/Weapons/Items/T-Icon-Pickaxes-DesertOpsFPickaxe.T-Icon-Pickaxes-DesertOpsFPickaxe";
        string icon1 = "/Game/UI/Foundation/Textures/Icons/Weapons/Items/T-Icon-Pickaxes-SK-Pickaxe-Spikes.T-Icon-Pickaxes-SK-Pickaxe-Spikes";
        ...
        private void backgroundWorker1_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            if (convertButton.Text == "Convert")
            {
                ...
                if (swap1)
                {
                    ...
                    Settings.Default.SpikyEnabled = true;
            ...
            else
            {
                ...
                {
                    RichTextBoxInfo.Text += "\n[LOG] Mesh removed";
                    Settings.Default.SpikyEnabled = false;
                    Settings.Default.Save();
                }
