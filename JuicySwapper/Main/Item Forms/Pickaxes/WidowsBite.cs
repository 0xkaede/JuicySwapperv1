...
{
    public partial class WidowsBite : Form
    {
        public WidowsBite()
        {
            InitializeComponent();
        ...
        {
            if (Properties.Settings.Default.WidowsBiteEnabled == true)
            {
        ...
        string Mesh1 = "/Game/Weapons/FORT_Melee/Pickaxe_AshtonBoardwalk/Meshes/Pickaxe_Ashton_Boardwalk.Pickaxe_Ashton_Boardwalk";
        ...
        string Equip1 = "/Game/Athena/Sounds/Weapons/PickAxes/AshtonBoardwalk/PA_AshtonBoardwalk_Ready_Athena_Cue.PA_AshtonBoardwalk_Ready_Athena_Cue";
        ...
        string Swing1 = "/Game/Athena/Sounds/Weapons/PickAxes/AshtonBoardwalk/PA_AshtonBoardwalk_Swing_Athena_Cue.PA_AshtonBoardwalk_Swing_Athena_Cue";
        ...
        string Impact1 = "/Game/Athena/Sounds/Weapons/PickAxes/AshtonBoardwalk/PA_AshtonBoardwalk_ImpactFlesh_Athena_Cue.PA_AshtonBoardwalk_ImpactFlesh_Athena_Cue";
        ...
        string Swingfx1 = "/Game/Weapons/FORT_Melee/Pickaxe_AshtonBoardwalk/FX/P_AshtonBoardwalk_Pickaxe_AnimTrail.P_AshtonBoardwalk_Pickaxe_AnimTrail";
        ...
        string Impactfx1 = "/Game/Weapons/FORT_Melee/Pickaxe_AshtonBoardwalk/FX/P_AshtonBoardwalk_Pickaxe_impact.P_AshtonBoardwalk_Pickaxe_impact";
        ...
        string Idlefx1 = "/Game/Weapons/FORT_Melee/Pickaxe_AshtonBoardwalk/FX/P_AshtonBoardwalk_Pickaxe_idle_FX.P_AshtonBoardwalk_Pickaxe_idle_FX";
        ...
        private void backgroundWorker1_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            if (convertButton.Text == "Convert")
            {
                ...
                if (swap1)
                {
                    ...
                    Settings.Default.WidowsBiteEnabled = true;
            ...
            else
            {
                ...
                {
                    RichTextBoxInfo.Text += "\n[LOG] Mesh removed";
                    Settings.Default.WidowsBiteEnabled = false;
                    Settings.Default.Save();
                }
