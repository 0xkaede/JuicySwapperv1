...
{
    public partial class MerryMintAxe : Form
    {
        public MerryMintAxe()
        {
            InitializeComponent();
        ...
        {
            if (Properties.Settings.Default.MerryMintEnabled == true)
            {
        ...
        string Mesh1 = "/Game/Weapons/FORT_Melee/Pickaxe_15/Meshes/SK_Pickaxe_15.SK_Pickaxe_15";
        ...
        string Mat1 = "/Game/Weapons/FORT_Melee/Pickaxe_CandyCane/Materials/MI_Pickaxe_CandyCane.MI_Pickaxe_CandyCane";
        ...
        string Equip1 = "/Game/Athena/Sounds/Weapons/PickAxes/CandyCane/Pickaxe_CandyCane_Equip2_Cue.Pickaxe_CandyCane_Equip2_Cue";
        ...
        string Swing1 = "/Game/Athena/Sounds/Weapons/PickAxes/CandyCane/Pickaxe_CandyCane_Swing_Cue.Pickaxe_CandyCane_Swing_Cue";
        ...
        string Impact1 = "/Game/Athena/Sounds/Weapons/PickAxes/CandyCane/Pickaxe_CandyCane_Impact_Cue.Pickaxe_CandyCane_Impact_Cue";
        ...
        string icon1 = "/Game/UI/Foundation/Textures/Icons/Weapons/Items/T-Icon-Pickaxes-CandyCanePickaxe.T-Icon-Pickaxes-CandyCanePickaxe";
        ...
        private void backgroundWorker1_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            if (convertButton.Text == "Convert")
            {
                ...
                if (swap1)
                {
                    ...
                    Settings.Default.MerryMintEnabled = true;
            ...
            else
            {
                ...
                {
                    RichTextBoxInfo.Text += "\n[LOG] Mesh removed";
                    Settings.Default.MerryMintEnabled = false;
                    Settings.Default.Save();
                }
