...
{
    public partial class TrustyNo2 : Form
    {
        public TrustyNo2()
        {
            InitializeComponent();
        ...
        {
            if (Properties.Settings.Default.TrustyNo2Enabled == true)
            {
        ...
        string Mesh = "/Game/Weapons/FORT_Melee/Pickaxe_BunkerMan/Meshes/Bunker_Man_Axe.Bunker_Man_Axe";
        string Mesh1 = "/Game/Weapons/FORT_Melee/Pickaxe_31/Meshes/SK_Pickaxe_31.SK_Pickaxe_31";
        string Equip = "/Game/Athena/Sounds/Weapons/PickAxes/BunkerMan/PickAxe_BunkerMan_Ready_Athena_Cue.PickAxe_BunkerMan_Ready_Athena_Cue";
        string Equip1 = "/Game/Athena/Sounds/Weapons/PickAxes/PickAxe_Assassin_Ready_Athena_Cue.PickAxe_Assassin_Ready_Athena_Cue";
        string Swing = "/Game/Athena/Sounds/Weapons/PickAxes/BunkerMan/PickAxe_BunkerMan_Swing_Athena_Cue.PickAxe_BunkerMan_Swing_Athena_Cue";
        string Swing1 = "/Game/Athena/Sounds/Weapons/PickAxes/PickAxe_Assassin_Swing_Athena_Cue.PickAxe_Assassin_Swing_Athena_Cue";
        string Impact = "/Game/Athena/Sounds/Weapons/PickAxes/BunkerMan/PickAxe_BunkerMan_Impact_Player_Athena_Cue.PickAxe_BunkerMan_Impact_Player_Athena_Cue";
        string Impact1 = "/Game/Sounds/Fort_Impact_Sounds/Flesh/Player_Impact_PA_Assassin_Cue.Player_Impact_PA_Assassin_Cue";
        string Impactfx = "/Game/Weapons/FORT_Melee/Pickaxe_BunkerMan/FX/P_Melee_BunkerMan_Impact.P_Melee_BunkerMan_Impact";
        string Impactfx1 = "/Game/Weapons/FORT_Melee/Pickaxe_BunkerMan/FX/P_Melee_BunkerMan_Impact.P_Melee_BunkerMan_Im0000";
        string icon = "/Game/UI/Foundation/Textures/Icons/Weapons/Items/T-Icon-Pickaxes-BunkerManPickaxe.T-Icon-Pickaxes-BunkerManPickaxe";
        string icon1 = "/Game/UI/Foundation/Textures/Icons/Weapons/Items/T-Icon-Pickaxes-SK-Pickaxe-31.T-Icon-Pickaxes-SK-Pickaxe-31";
        ...
        private void backgroundWorker1_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            if (convertButton.Text == "Convert")
            {
                ...
                if (swap1)
                {
                    ...
                    Settings.Default.TrustyNo2Enabled = true;
                ...
                bool swap5 = Engine.Convert(offsetpick, pickaxepath, Impactfx, Impactfx1, 0, 0, false, false);
                if (swap5)
            ...
            else
            {
                ...
                {
                    RichTextBoxInfo.Text += "\n[LOG] Mesh removed";
                    Settings.Default.TrustyNo2Enabled = false;
                    Settings.Default.Save();
                }
                ...
                bool swap5 = Engine.Revert(offsetpick, pickaxepath, Impactfx, Impactfx1, 0, 0, false, false);
                if (swap5)
