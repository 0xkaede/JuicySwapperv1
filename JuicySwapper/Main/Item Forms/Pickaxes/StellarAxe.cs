...
namespace JuicySwapper.Main.Item.Pickaxes
{
    public partial class StellarAxe : Form
    {
        ...
        {
            if (Properties.Settings.Default.StellarAxeEnabled == true)
            {
        ...
        string Mat1 = "/Game/Weapons/FORT_Melee/Materials/MI_FORT_Melee_Pick_Celestial.MI_FORT_Melee_Pick_Celestial";
        ...
        string Swing1 = "/Game/Athena/Sounds/Weapons/PickAxes/Celestial/PickAxe_Celestial_Swing_Cue.PickAxe_Celestial_Swing_Cue";
        ...
        string Equip1 = "/Game/Athena/Sounds/Weapons/PickAxes/FlintlockWinter/Pickaxe_WinterFlintlock_Ready.Pickaxe_WinterFlintlock_Re000";
        ...
        string Impact1 = "/Game/Athena/Sounds/Weapons/PickAxes/Celestial/Pickaxe_Celestial_Impact_Cue.Pickaxe_Celestial_Impact_Cue";
        ...
        string icon1 = "/Game/UI/Foundation/Textures/Icons/Weapons/Items/T-Icon-Pickaxes-Pickaxe-ID-116-Celestial.T-Icon-Pickaxes-Pickaxe-ID-116-Celestial";
