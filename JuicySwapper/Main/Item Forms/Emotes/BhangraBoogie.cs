...
{
    public partial class BhangraBoogie : Form
    {
        public BhangraBoogie()
        {
            InitializeComponent();
        ...
        {
            if (Properties.Settings.Default.BhangraBoogieEnabled == true)
            {
        ...
        string CMM = "/Game/Animation/Game/MainPlayer/Emotes/Snowglobe/Emote_Snowglobe_CMM_M.Emote_Snowglobe_CMM_M";
        string CMM1 = "/Game/Animation/Game/MainPlayer/Emotes/bhangra/emote_bhangra_CMM_M.emote_bhangra_CMM_M";
        string CMF = "/Game/Animation/Game/MainPlayer/Emotes/Snowglobe/Emote_Snowglobe_CMF_M.Emote_Snowglobe_CMF_M";
        string CMF1 = "/Game/Animation/Game/MainPlayer/Emotes/bhangra/emote_bhangra_CMF_M.emote_bhangra_CMF_M";
        ...
        private void backgroundWorker1_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            if (convertButton.Text == "Convert")
            {
                ...
                {
                    RichTextBoxInfo.Text += "\n[LOG] Dance 1/2 added";
                    Settings.Default.BhangraBoogieEnabled = true;
            ...
            else
            {
                ...
                if (swap1)
                {
                    ...
                    Settings.Default.BhangraBoogieEnabled = false;
                    Settings.Default.Save();
                }
