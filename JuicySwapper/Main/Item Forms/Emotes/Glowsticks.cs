...
{
    public partial class Glowsticks : Form
    {
        public Glowsticks()
        {
            InitializeComponent();
        ...
        {
            if (Properties.Settings.Default.GlowsticksEnabled == true)
            {
        ...
        private void backgroundWorker1_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            if (convertButton.Text == "Convert")
            {
                ...
                {
                    RichTextBoxInfo.Text += "\n[LOG] Dance 1/2 added!";
                    Settings.Default.GlowsticksEnabled = true;
            ...
            else
            {
                ...
                if (swap1)
                {
                    ...
                    Settings.Default.GlowsticksEnabled = false;
                    Settings.Default.Save();
                }
