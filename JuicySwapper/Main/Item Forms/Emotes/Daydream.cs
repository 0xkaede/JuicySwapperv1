...
{
    public partial class Daydream : Form
    {
        public Daydream()
        {
            InitializeComponent();
        ...
        {
            if (Properties.Settings.Default.DaydreamEnabled == true)
            {
        ...
        string CMM = "/Game/Animation/Game/MainPlayer/Emotes/Dance_SwipeIt/Emote_Dance_SwipeIt_CMM_M.Emote_Dance_SwipeIt_CMM_M";
        string CMM1 = "/Game/Animation/Game/MainPlayer/Emotes/HiLoWave/Emote_HiLowWave_CMM_M.Emote_HiLowWave_CMM_M";
        string CMF = "/Game/Animation/Game/MainPlayer/Emotes/Dance_SwipeIt/Emote_Dance_SwipeIt_CMF_M.Emote_Dance_SwipeIt_CMF_M";
        string CMF1 = "/Game/Animation/Game/MainPlayer/Emotes/HiLoWave/Emote_HiLowWave_CMF_M.Emote_HiLowWave_CMF_M";
        ...
        private void backgroundWorker1_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            if (convertButton.Text == "Convert")
            {
                ...
                {
                    RichTextBoxInfo.Text += "\n[LOG] Dance 1/2 added!";
                    Settings.Default.DaydreamEnabled = true;
