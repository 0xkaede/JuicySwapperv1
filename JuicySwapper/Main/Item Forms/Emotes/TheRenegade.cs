...
{
    public partial class TheRenegade : Form
    {
        public TheRenegade()
        {
            InitializeComponent();
        ...
        {
            if (Properties.Settings.Default.TheRenegadeEnabled == true)
            {
        ...
        string CMM1 = "/Game/Animation/Game/MainPlayer/Emotes/JustHome/Emote_JustHome_CMM_M.Emote_JustHome_CMM_M";
        string CMF = "/Game/Animation/Game/MainPlayer/Emotes/Snowglobe/Emote_Snowglobe_CMF_M.Emote_Snowglobe_CMF_M";
        string CMF1 = "/Game/Animation/Game/MainPlayer/Emotes/JustHome/Emote_JustHome_CMF_M.Emote_JustHome_CMF_M";
        ...
        private void backgroundWorker1_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            if (convertButton.Text == "Convert")
            {
                ...
                {
                    RichTextBoxInfo.Text += "\n[LOG] Dance 1/2 added!";
                    Settings.Default.TheRenegadeEnabled = true;
            ...
            else
            {
                ...
                if (swap1)
                {
                    ...
                    Settings.Default.TheRenegadeEnabled = false;
                    Settings.Default.Save();
                }
