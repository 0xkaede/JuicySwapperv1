...
{
    public partial class Llamacadabra : Form
    {
        public Llamacadabra()
        {
            InitializeComponent();
        ...
        {
            if (Properties.Settings.Default.LlamacadabraEnabled == true)
            {
        ...
        string CMM1 = "/Game/Animation/Game/MainPlayer/Emotes/Wizard/Emote_Wizard_CMM_M.Emote_Wizard_CMM_M";
        ...
        string CMF1 = "/Game/Animation/Game/MainPlayer/Emotes/Wizard/Emote_Wizard_CMF_M.Emote_Wizard_CMF_M";
        ...
        private void backgroundWorker1_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            if (convertButton.Text == "Convert")
            {
                ...
                {
                    RichTextBoxInfo.Text += "\n[LOG] Dance 1/2 added!";
                    Settings.Default.LlamacadabraEnabled = true;
            ...
            else
            {
                ...
                if (swap1)
                {
                    ...
                    Settings.Default.LlamacadabraEnabled = false;
                    Settings.Default.Save();
                }
