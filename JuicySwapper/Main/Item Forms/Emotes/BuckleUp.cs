...
{
    public partial class BuckleUp : Form
    {
        public BuckleUp()
        {
            InitializeComponent();
        ...
        {
            if (Properties.Settings.Default.BuckleUpEnabled == true)
            {
        ...
        string CMM1 = "/Game/Animation/Game/MainPlayer/Emotes/LineDance/Emote_LineDance_CMM_M.Emote_LineDance_CMM_M";
        string CMF = "/Game/Animation/Game/MainPlayer/Emotes/Snowglobe/Emote_Snowglobe_CMF_M.Emote_Snowglobe_CMF_M";
        string CMF1 = "/Game/Animation/Game/MainPlayer/Emotes/LineDance/Emote_LineDance_CMF_M.Emote_LineDance_CMF_M";
        ...
        private void backgroundWorker1_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            if (convertButton.Text == "Convert")
            {
                ...
                {
                    RichTextBoxInfo.Text += "\n[LOG] Dance 1/2 added!";
                    Settings.Default.BuckleUpEnabled = true;
            ...
            else
            {
                ...
                if (swap1)
                {
                    ...
                    Settings.Default.BuckleUpEnabled = false;
                    Settings.Default.Save();
                }
