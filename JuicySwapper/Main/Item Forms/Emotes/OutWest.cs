...
{
    public partial class OutWest : Form
    {
        public OutWest()
        {
            InitializeComponent();
        ...
        {
            if (Properties.Settings.Default.outwestEnabled == true)
            {
        ...
        string CMM = "/Game/Animation/Game/MainPlayer/Emotes/Eating_Popcorn/Emote_eating_popcorn_CMF.Emote_eating_popcorn_CMF";
        string CMM1 = "/Game/Animation/Game/MainPlayer/Emotes/JulyBooks/Emote_JulyBooks_CMF_M.Emote_JulyBooks_CMF_M";
        string CMF = "/Game/Animation/Game/MainPlayer/Emotes/Eating_Popcorn/Emote_eating_popcorn_CMM.Emote_eating_popcorn_CMM";
        string CMF1 = "/Game/Animation/Game/MainPlayer/Emotes/JulyBooks/Emote_JulyBooks_CMM_M.Emote_JulyBooks_CMM_M";
        ...
        private void backgroundWorker1_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            if (convertButton.Text == "Convert")
            {
                ...
                {
                    RichTextBoxInfo.Text += "\n[LOG] Dance 1/2 added!";
                    Settings.Default.outwestEnabled = true;
            ...
            else
            {
                ...
                if (swap1)
                {
                    ...
                    Settings.Default.outwestEnabled = false;
                    Settings.Default.Save();
                }
