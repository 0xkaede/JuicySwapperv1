...
{
    public partial class Poki : Form
    {
        public Poki()
        {
            InitializeComponent();
        ...
        {
            if (Properties.Settings.Default.PokiEnabled == true)
            {
        ...
        string CMM1 = "/Game/Animation/Game/MainPlayer/Emotes/IndigoApple/Emote_IndigoApple_CMF_M.Emote_IndigoApple_CMF_M";
        string CMF = "/Game/Animation/Game/MainPlayer/Emotes/Eating_Popcorn/Emote_eating_popcorn_CMM.Emote_eating_popcorn_CMM";
        string CMF1 = "/Game/Animation/Game/MainPlayer/Emotes/IndigoApple/Emote_IndigoApple_CMM_M.Emote_IndigoApple_CMM_M";
        ...
        private void backgroundWorker1_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            if (convertButton.Text == "Convert")
            {
                ...
                {
                    RichTextBoxInfo.Text += "\n[LOG] Dance 1/2 added!";
                    Settings.Default.PokiEnabled = true;
