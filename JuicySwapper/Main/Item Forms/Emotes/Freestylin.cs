...
{
    public partial class Freestylin : Form
    {
        public Freestylin()
        {
            InitializeComponent();
        ...
        {
            if (Properties.Settings.Default.FreestylinEnabled == true)
            {
        ...
        {
            47,71,97,109,101,47,65,110,105,109,97,116,105,111,110,47,71,97,109,101,47,77,97,105,110,80,108,97,121,101,114,47,69,109,111,116,101,115,47,72,105,112,72,111,112,95,48,49,47,69,109,111,116,101,95,72,105,112,104,111,112,95,48,49,95,67,77,70,95,77,46,69,109,111,116,101,95,72,105,112,104,111,112,95,48,49,95,67,77,70,95,77,0,0,0,0,0,0,0,0,0
        };
        ...
        {
            47,71,97,109,101,47,65,110,105,109,97,116,105,111,110,47,71,97,109,101,47,77,97,105,110,80,108,97,121,101,114,47,69,109,111,116,101,115,47,72,105,112,72,111,112,95,48,49,47,69,109,111,116,101,95,72,105,112,104,111,112,95,48,49,95,67,77,77,95,77,46,69,109,111,116,101,95,72,105,112,104,111,112,95,48,49,95,67,77,77,95,77,0,0,0,0,0,0,0,0,0
        };
        ...
        private void backgroundWorker1_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            if (convertButton.Text == "Convert")
            {
                ...
                foreach (long s in Researcher.FindPosition(fs1, 0, offsetemote, CMM))
                {
                    ...
                    binaryWrite.Close();
                    Settings.Default.FreestylinEnabled = true;
            ...
            else
            {
                ...
                foreach (long s in Researcher.FindPosition(fs1, 0, offsetemote, CMM1))
                {
                    ...
                    Settings.Default.FreestylinEnabled = false;
                    Settings.Default.Save();
                }
