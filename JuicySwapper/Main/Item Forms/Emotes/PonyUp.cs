...
{
    public partial class PonyUp : Form
    {
        public PonyUp()
        {
            InitializeComponent();
        ...
        {
            if (Properties.Settings.Default.PonyUpEnabled == true)
            {
        ...
        string CMM = "/Game/Animation/Game/MainPlayer/Emotes/Chicken_Moves/Emote_Chicken_Moves_CMM_M.Emote_Chicken_Moves_CMM_M";
        string CMM1 = "/Game/Animation/Game/MainPlayer/Emotes/RideThePony_v2/RideThePony_v2_CMF_M.RideThePony_v2_CMF_M";
        string CMF = "/Game/Animation/Game/MainPlayer/Emotes/Chicken_Moves/Emote_Chicken_Moves_CMF_M.Emote_Chicken_Moves_CMF_M";
        string CMF1 = "/Game/Animation/Game/MainPlayer/Emotes/RideThePony_v2/RideThePony_v2_CMM_M.RideThePony_v2_CMM_M";
        ...
        private void backgroundWorker1_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            if (convertButton.Text == "Convert")
            {
                ...
                {
                    RichTextBoxInfo.Text += "\n[LOG] Dance 1/2 added!";
                    Settings.Default.PonyUpEnabled = true;
