...
{
    public partial class Infectious : Form
    {
        public Infectious()
        {
            InitializeComponent();
        ...
        {
            if (Properties.Settings.Default.InfectiousEnabled == true)
            {
		...
		private void backgroundWorker1_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            if (convertButton.Text == "Convert")
            {
				...
				foreach (long s in Researcher.FindPosition(fs1, 0, offsetemote, bb1))
				{
					...
					binaryWrite.Close();
					Settings.Default.InfectiousEnabled = true;
            ...
            else
            {
				...
				foreach (long s in Researcher.FindPosition(fs1, 0, offsetemote, bb2))
				{
					...
					binaryWrite.Close();
					Settings.Default.InfectiousEnabled = false;
					Settings.Default.Save();
