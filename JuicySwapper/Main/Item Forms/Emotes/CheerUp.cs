...
{
    public partial class CheerUp : Form
    {
        public CheerUp()
        {
            InitializeComponent();
        ...
        {
            if (Properties.Settings.Default.CheerUpEnabled == true)
            {
        ...
        {
            47,71,97,109,101,47,65,110,105,109,97,116,105,111,110,47,71,97,109,101,47,77,97,105,110,80,108,97,121,101,114,47,69,109,111,116,101,115,47,67,104,101,101,114,108,101,97,100,101,114,47,69,109,111,116,101,95,67,104,101,101,114,108,101,97,100,101,114,95,67,77,70,95,77,46,69,109,111,116,101,95,67,104,101,101,114,108,101,97,100,101,114,95,67,77,70,95,77,0,0,0
        };
        private static byte[] CMM = new byte[]
        {
            47,71,97,109,101,47,65,110,105,109,97,116,105,111,110,47,71,97,109,101,47,77,97,105,110,80,108,97,121,101,114,47,69,109,111,116,101,115,47,84,97,107,101,95,84,104,101,95,69,108,102,47,69,109,111,116,101,95,84,97,107,101,95,84,104,101,95,69,108,102,95,67,77,77,95,77,46,69,109,111,116,101,95,84,97,107,101,95,84,104,101,95,69,108,102,95,67,77,77,95,77
        };
        private static byte[] CMM1 = new byte[]
        {
            47,71,97,109,101,47,65,110,105,109,97,116,105,111,110,47,71,97,109,101,47,77,97,105,110,80,108,97,121,101,114,47,69,109,111,116,101,115,47,67,104,101,101,114,108,101,97,100,101,114,47,69,109,111,116,101,95,67,104,101,101,114,108,101,97,100,101,114,95,67,77,77,95,77,46,69,109,111,116,101,95,67,104,101,101,114,108,101,97,100,101,114,95,67,77,77,95,77,0,0,0
        };
        ...
        private void backgroundWorker1_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            if (convertButton.Text == "Convert")
            {
                ...
                foreach (long s in Researcher.FindPosition(fs1, 0, offsetemote, CMM))
                {
                    ...
                    binaryWrite.Close();
                    Settings.Default.CheerUpEnabled = true;
            ...
            else
            {
                ...
                foreach (long s in Researcher.FindPosition(fs1, 0, offsetemote, CMM1))
                {
                    ...
                    Settings.Default.CheerUpEnabled = false;
                    Settings.Default.Save();
                }
