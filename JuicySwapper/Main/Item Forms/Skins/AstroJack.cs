...
{
    public partial class AstroJack : Form
    {
        public AstroJack()
        {
            InitializeComponent();
        ...
        private void convertButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (convertButton.Text == "Convert")
                {
                    ...
                    Properties.Settings.Default.AstroJackEnabled = true;
        ...
        {
            if (Properties.Settings.Default.AstroJackEnabled == true)
            {
                convertButton.Text = "Revert";
            }
            else
