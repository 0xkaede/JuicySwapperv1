...
namespace JuicySwapper.Main.GUI
{
    public partial class RenegadeRaiderC : Form
    {
        ...
        {
            if (Properties.Settings.Default.RenegadeCEnabled == true)
            {
        ...
        private void backgroundWorker1_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            if (convertButton.Text == "Convert")
            {
                ...
                if (swap1)
                {
                    ...
                    Settings.Default.RenegadeCEnabled = true;
                ...
                bool swap3 = Engine.Convert(Offset_Skin_Head, headpath, Color, Color1, 0, 0, false, false);
                if (swap3)
                    RichTextBoxInfo.Text += "\n[LOG] Color added";
            ...
            else
            {
                ...
                if (swap1)
                {
                    ...
                    Settings.Default.RenegadeCEnabled = false;
                    Settings.Default.Save();
                }
                ...
                bool swap3 = Engine.Revert(Offset_Skin_Head, headpath, Color, Color1, 0, 0, false, false);
                if (swap3)
                    RichTextBoxInfo.Text += "\n[LOG] Color removed";
