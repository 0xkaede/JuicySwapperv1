...
{
    public partial class MogulMasterFRA : Form
    {
        public MogulMasterFRA()
        {
            InitializeComponent();
        ...
        {
            47,71,97,109,101,47,67,104,97,114,97,99,116,101,114,115,47,67,104,97,114,97,99,116,101,114,80,97,114,116,115,47,70,101,109,97,108,101,47,77,101,100,105,117,109,47,66,111,100,105,101,115,47,70,95,77,101,100,95,83,111,108,100,105,101,114,95,66,82,52,50,95,70,82,65,46,70,95,77,101,100,95,83,111,108,100,105,101,114,95,66,82,52,50,95,70,82,65,0,0,0,0,0
        };
        ...
        {
            47,71,97,109,101,47,65,116,104,101,110,97,47,72,101,114,111,101,115,47,77,101,115,104,101,115,47,72,101,97,100,115,47,70,95,77,101,100,95,83,111,108,100,105,101,114,95,83,107,105,77,97,115,107,95,48,49,95,65,84,72,95,70,82,65,46,70,95,77,101,100,95,83,111,108,100,105,101,114,95,83,107,105,77,97,115,107,95,48,49,95,65,84,72,95,70,82,65,0,0,0,0,0
        };
        ...
        private void convertButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (convertButton.Text == "Convert")
                {
                    ...
                    Properties.Settings.Default.MogulFRAEnabled = true;
        ...
        {
            if (Properties.Settings.Default.MogulFRAEnabled == true)
            {
                convertButton.Text = "Revert";
            }
            else
