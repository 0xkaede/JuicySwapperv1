...
{
    public partial class TropicalPunchZoey : Form
    {
        public TropicalPunchZoey()
        {
            InitializeComponent();
        ...
        {
            47,71,97,109,101,47,65,116,104,101,110,97,47,72,101,114,111,101,115,47,77,101,115,104,101,115,47,66,111,100,105,101,115,47,67,80,95,66,111,100,121,95,67,111,109,109,97,110,100,111,95,70,95,67,97,110,100,121,83,117,109,109,101,114,46,67,80,95,66,111,100,121,95,67,111,109,109,97,110,100,111,95,70,95,67,97,110,100,121,83,117,109,109,101,114,0,0,0,0,0,0,0,0
        };
        ...
        private void convertButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (convertButton.Text == "Convert")
                {
                    ...
                    Properties.Settings.Default.TropicalZoeyEnabled = true;
        ...
        {
            if (Properties.Settings.Default.TropicalZoeyEnabled == true)
            {
                convertButton.Text = "Revert";
            }
            else
