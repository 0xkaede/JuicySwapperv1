...
{
    public partial class FinesseFinisher : Form
    {
        public FinesseFinisher()
        {
            InitializeComponent();
        ...
        private void convertButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if(convertButton.Text == "Convert")
                {
                    ...
                    Settings.Default.FinesseEnabled = true;
                ...
                else
                {
                    ...
                    Settings.Default.FinesseEnabled = false;
                    Settings.Default.Save();
        ...
        {
            if (Properties.Settings.Default.FinesseEnabled == true)
            {
                convertButton.Text = "Revert";
            }
            else
