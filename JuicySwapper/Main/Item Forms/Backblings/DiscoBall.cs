...
namespace JuicySwapper.Main.GUI
{
    public partial class DiscoBall : Form
    {
        ...
        {
            InitializeComponent();
            MessageBox.Show("In lobby, it appears as Black Shield, however shows as Disco Ball in game.");
        ...
        string Mesh1 = "/Game/Accessories/FORT_Backpacks/F_MED_Funk_Ops_Backpack/Meshes/F_MED_Funk_Ops_Backpack.F_MED_Funk_Ops_Backpack";
        ...
        string FX1 = "/Game/Effects/Fort_Effects/Effects/Characters/Athena_Parts/CCPM_Funk_Ops_Remix_Backpack.CCPM_Funk_Ops_Remix_Backpack_C";
        string BID = "/Game/Athena/Items/Cosmetics/Backpacks/BID_242_FurnaceFace.BID_242_FurnaceFace";
        string BID1 = "/Game/Athena/Items/Cosmetics/Backpacks/BID_004_BlackKnight.BID_004_BlackKnight";
        ...
        private void backgroundWorker1_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            if (convertButton.Text == "Convert")
            {
                ...
                if (swap1)
                {
                    ...
                    Settings.Default.DiscoBallEnabled = true;
            ...
            else
            {
                ...
                {
                    RichTextBoxInfo.Text += "\n[LOG] Mesh removed";
                    Settings.Default.DiscoBallEnabled = false;
                    Settings.Default.Save();
                }
