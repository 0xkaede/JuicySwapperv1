...
{
    public partial class FallenWings : Form
    {
        public FallenWings()
        {
            InitializeComponent();
        ...
        {
            47,48,48,48,48,47,67,104,97,114,97,99,116,101,114,115,47,80,108,97,121,101,114,47,77,97,108,101,47,77,101,100,105,117,109,47,66,111,100,105,101,115,47,77,95,77,101,100,95,67,111,109,109,97,110,100,111,95,67,117,112,105,100,47,83,107,105,110,115,47,73,99,101,47,77,97,116,101,114,105,97,108,115,47,77,95,77,101,100,95,83,111,108,100,105,101,114,95,67,117,112,105,100,95,87,105,110,103,115,46,77,95,77,101,100,95,83,111,108,100,105,101,114,95,67,117,112,105,100,95,87,105,110,103,115
        };
        ...
        {
            66,73,68,95,50,48,56,95,67,117,112,105,100,68,97,114,107,77,97,108,101,46,66,73,68,95,50,48,56,95,67,117,112,105,100,68,97,114,107,77,97,108,101,0,0,0,0
        };
        private void backgroundWorker1_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            if (convertButton.Text == "Convert")
            {
                ...
                foreach (long s in Researcher.FindPosition(fs1, 0, offsetback, Mesh))
                {
                    ...
                    binaryWrite.Close();
                    Settings.Default.FallenWingsEnabled = true;
            ...
            else
            {
                ...
                foreach (long s in Researcher.FindPosition(fs1, 0, offsetback, Mesh1))
                {
                    ...
                    binaryWrite.Close();
                    Settings.Default.FallenWingsEnabled = false;
                    Settings.Default.Save();
                    RichTextBoxInfo.Text = RichTextBoxInfo.Text + "\n[LOG] Mesh removed";
                }
