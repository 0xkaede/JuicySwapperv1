...
{
    public partial class AutumnsMantle : Form
    {
        public AutumnsMantle()
        {
            InitializeComponent();
        ...
        private static byte[] Mesh = new byte[115]
         {
      47,71,97,109,101,47,65,99,99,101,115,115,111,114,105,101,115,47,70,79,82,84,95,66,97,99,107,112,97,99,107,115,47,66,97,99,107,112,97,99,107,95,70,95,77,69,68,95,82,111,99,107,95,67,108,105,109,98,101,114,47,77,101,115,104,101,115,47,70,95,77,69,68,95,82,111,99,107,95,67,108,105,109,98,101,114,95,80,97,99,107,46,70,95,77,69,68,95,82,111,99,107,95,67,108,105,109,98,101,114,95,80,97,99,107
         };
        private static byte[] Mesh1 = new byte[115]
        {
     47,71,97,109,101,47,65,99,99,101,115,115,111,114,105,101,115,47,70,79,82,84,95,66,97,99,107,112,97,99,107,115,47,70,95,77,69,68,95,70,111,114,101,115,116,95,81,117,101,101,110,95,66,97,99,107,112,97,99,107,47,77,101,115,104,101,115,47,70,95,77,69,68,95,70,111,114,101,115,116,95,81,117,101,101,110,95,80,97,99,107,46,70,95,77,69,68,95,70,111,114,101,115,116,95,81,117,101,101,110,95,80,97,99,107
        };

        private static byte[] BID = new byte[39]
       {
66,73,68,95,51,54,56,95,82,111,99,107,67,108,105,109,98,101,114,46,66,73,68,95,51,54,56,95,82,111,99,107,67,108,105,109,98,101,114
       };
        private static byte[] BID1 = new byte[39]
      {
66,73,68,95,52,49,51,95,70,111,114,101,115,116,81,117,101,101,110,46,66,73,68,95,52,49,51,95,70,111,114,101,115,116,81,117,101,101,110
      };
        ...
        private void backgroundWorker1_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            if (convertButton.Text == "Convert")
            {
                ...
                foreach (long s in Researcher.FindPosition(fs1, 0, offsetback, Mesh))
                {
                    ...
                    binaryWrite.Close();
                    Settings.Default.AutumnsMantleEnabled = true;
            ...
            else
            {
                ...
                foreach (long s in Researcher.FindPosition(fs1, 0, offsetback, Mesh1))
                {
                    ...
                    binaryWrite.Close();
                    Settings.Default.AutumnsMantleEnabled = false;
                    Settings.Default.Save();
                    RichTextBoxInfo.Text = RichTextBoxInfo.Text + "\n[LOG] Mesh removed";
                }
