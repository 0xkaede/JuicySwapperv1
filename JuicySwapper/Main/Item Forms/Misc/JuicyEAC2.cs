...
{
    public partial class JuicyEAC2 : Form
    {
        public JuicyEAC2()
        {
            InitializeComponent();
        ...
        private void backgroundWorker1_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            if (convertButton.Text == "Convert")
            {
                ...
                Download.DownloadFile("https://cdn.discordapp.com/attachments/729442108703899730/740299805879697518/JuicyEAC2.png", stringBuilder.ToString() + "\\SplashScreen.png"); 
                RichTextBoxInfo.Text += "\n[LOG] Converted 1/1";
                Settings.Default.JuicyEAC2Enabled = true;
                convertButton.Text = "Revert";
                stopwatch.Stop();
            ...
            else
            {
                ...
                RichTextBoxInfo.Text += "\n[LOG] Reverted 1/1";
                Settings.Default.JuicyEAC2Enabled = false;
                convertButton.Text = "Convert";
                stopwatch.Stop();
                double numb = (double)stopwatch.Elapsed.Milliseconds;
